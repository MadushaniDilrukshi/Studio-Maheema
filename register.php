...
$query = "INSERT INTO maheema_studio.user (fname,lname,email,tell,uname,pass) VALUES ('{$fname}','{$lname}','{$email}','{$tell}','{$uname}','{$passw}')";
...
<p style="color: #ffffff">First name: </p><input type="text" name="fname"/><br><br>
<p style="color: #ffffff">Last name:</p> <input type="text" name="lname"/><br><br>
<p style="color: #ffffff">Email : </p><input type="text" name="email"/><br><br>
<p style="color: #ffffff">Mobile number: </p><input type="text" name="tell"/><br><br>
<p style="color: #ffffff">User name: </p><input type="text" name="unam"/><br><br>
<p style="color: #ffffff">password:</p> <input type="text" name="pass"/><br><br>
